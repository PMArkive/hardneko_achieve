...
public void OnPluginStart() {
	...
	g_hCVar_ChMapBroadcastInterval =  CreateConVar("l4d2_acs_chmap_broadcast_interval", "180.0", "设置循环公告投票指令 \"!chmap\" 的时间(秒). 0=禁用.", FCVAR_NOTIFY);	
...
void MakeChMapBroadcastTimer() {
	if(g_hCVar_ChMapPolicy.FloatValue != 0 && g_hCVar_ChMapPolicy.FloatValue == 1 && g_hCVar_ChMapBroadcastInterval.FloatValue > 0)
	{
